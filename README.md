...
El objetivo principal del proyecto es demostrar la capacidad de comprender y aplicar la lógica de programación en Python mediante la resolución de 41 ejercicios progresivos.

Durante el desarrollo se han utilizado conceptos clave como:

* Uso de funciones y métodos aplicados a diferentes estructuras de datos:
list, tuple, set, dict
...
def, lambdas, list comprehension, map, filter, reduce

* Manejo de inputs, control de errores con try y except
  
* Programación orientada a objetos:
  creación de clases, instanciación de objetos y uso de métodos constructores
